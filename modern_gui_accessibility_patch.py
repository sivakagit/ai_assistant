...
────────────────────────────────────────────────────────────────────
    ...
    from accessibility import init_engine          # ← ADD THIS LINE
...
────────────────────────────────────────────────────────────────────
    ...
    # ... your existing read_screen / screenshot / last_screen blocks ...
        ...
        if _intent == "explain_screen":
            ...
            def _do_explain():
                from screen_reader import explain_screen as _es
                result = _es()
        ...
        if _intent == "read_handwriting":
            ...
            from tools_manager import read_handwriting_tool
...
────────────────────────────────────────────────────────────────────
    ...
    def main():
        ...
        from accessibility import init_engine
        from tts import speak_async, stop as stop_tts
